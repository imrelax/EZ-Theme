        ...
        <div class="plan-card" v-else v-for="plan in filteredPlans" :key="plan.id">
          <div class="card-header">
            ...
            <div
              ...
              v-if="
                plan.capacity_limit >= SHOP_CONFIG.lowStockThreshold || plan.capacity_limit === null
              "
            >
            ...
            <div
              ...
              v-else-if="
                plan.capacity_limit > 0 && plan.capacity_limit < SHOP_CONFIG.lowStockThreshold
              "
            >
              <IconBox :size="16" class="badge-icon" />
          ...
          <div class="card-body">
            ...
            <div
              ...
              v-if="SHOP_CONFIG.enableDiscountCalculation && calculateDiscount(plan).showDiscount"
            >
              <div class="discount-info">
                ...
                <span class="saving-amount"
                  >&nbsp;{{ currencySymbol }}{{ calculateDiscount(plan).savingsAmount }}</span
                >
              </div>
            </div>
            ...
            >
              ...
              <span class="btn-text">{{
                plan.capacity_limit === 0 ? $t('shop.plan.sold_out_btn') : $t('shop.plan.purchase')
              }}</span>
            </button>
          </div>
        </div>
                ...
                plans.value.forEach((plan) => {
                  ...
                  if (defaultRecurring) {
                    ...
                    selectedPriceType[plan.id] =
                      priceTypes.find((type) => plan[type] !== null) || priceTypes[0];
                  }
                });
              });
            } else {
