        ...
        <div class="messages-container">
          ...
          <div v-else class="message-list">
            <div
              ...
              :key="message.id"
              :class="['message-item', message.is_admin ? 'admin-message' : 'user-message']"
            >
        ...
        <div v-if="selectedTicket.status === 0" class="reply-box">
          ...
          >
            ...
            >
              ...
              <span v-if="!uploadingReplyImages">{{ $t('tickets.upPictures') || '上传图片' }}</span>
  ...
  const submitTicket = async () => {
    ...
    try {
      ...
      if (TICKET_CONFIG.includeUserInfoInTicket) {
        const [userInfoResponse, commConfigResponse, subscribeResponse, ipInfoResponse] =
          await Promise.all([
            getUserInfo(),
