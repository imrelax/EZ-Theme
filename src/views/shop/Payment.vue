      ...
      <div class="content-wrapper">
        ...
        <div class="right-column">
            ...
            <div class="status-info" v-if="!loading.order">
              <div class="order-status-notice" :class="getStatusClass(orderDetail.status)">
                ...
                <div class="status-text">
                  ...
                  <p v-if="orderDetail.status === 0 && orderDetail.total_amount > 0">
          ...
          <div
            ...
            v-if="!loading.order && orderDetail.total_amount === 0 && orderDetail.status === 0"
          >
            <div class="section-title">
          ...
          <div class="action-buttons">
            ...
            <div
              ...
              v-if="fromOrderList && (paymentSuccessful || orderDetail.status !== 0)"
            >
            ...
            <div
              class="btn-group pay-row"
              v-if="(paymentSuccessful || orderDetail.status > 0) && !fromOrderList"
            >
