          ...
          <div class="section-wrapper">
            ...
            <div class="coupon-input">
              ...
              >
                ...
                <span>{{
                  couponApplied ? $t('order.coupon_applied') : $t('order.verify_coupon')
                }}</span>
              </button>

              <button v-if="couponApplied" class="btn-remove-coupon" @click="removeCoupon">
                <IconX :size="16" />
    ...
    setup() {
      ...
      const fetchUserInfo = async () => {
        ...
        try {
          ...
          showToast(
            error.response?.message || error.message || t('dashboard.userinfo_error'),
            'error'
          );
        } finally {
