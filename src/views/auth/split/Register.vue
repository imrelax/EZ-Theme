          ...
          <form class="auth-form" @submit.prevent="handleRegister">
            <div class="form-group">
              ...
              >
                ...
                >
                  ...
                  <IconChevronDown
                    class="suffix-icon"
                    :class="{ 'rotate-180': showSuffixDropdown }"
                  />
            ...
            <div class="form-group" v-if="config.is_email_verify === 1">
              <label for="verificationCode" class="form-label"
                >{{ $t('common.verificationCode') }} <span class="required">*</span></label
              >
            ...
            <div class="form-group">
              <label for="password" class="form-label"
                >{{ $t('common.password') }} <span class="required">*</span></label
              >
            ...
            <div class="form-group">
              <label for="confirmPassword" class="form-label"
                >{{ $t('common.confirmPassword') }} <span class="required">*</span></label
              >
            ...
            <div class="form-group" v-if="config.is_recaptcha === 1">
              <label class="form-label"
                >{{ $t('auth.captcha') }} <span class="required">*</span></label
              >
            ...
            <div class="form-group agreement-checkbox">
              <label class="checkbox-container">
                ...
                <span class="checkbox-label">
                  ...
                  <a :href="config.tos_url || '#'" target="_blank" class="">{{
      ...
      const fetchWebsiteConfig = async () => {
        try {
          ...
          if (response && response.data) {
            ...
            if (
              Array.isArray(config.email_whitelist_suffix) &&
              config.email_whitelist_suffix.length > 0
            ) {
      ...
      .checkbox-label {
        ...
        a {
          ...
          background: linear-gradient(
            90deg,
            var(--theme-color) 0%,
            var(--theme-hover-color, #4bc8a2) 100%
          );
