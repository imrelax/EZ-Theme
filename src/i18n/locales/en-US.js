...
export default {
  ...
  dashboard: {
    ...
    resetDataCycleNotice:
      'Clicking "Got it" will deduct the remaining subscription time of the current data cycle. The system will reset your used data.',
    ...
    resetTrafficDesc:
      'This action will reset used traffic but will not extend the plan duration, continue?',
    ...
    manualImportRequired:
      'Automatic import not possible, please manually copy the subscription link',
  ...
  profile: {
    ...
    resetSecurityConfirm:
      'Are you sure you want to reset the subscription? After resetting, your previous subscription will become invalid, and you need to re-import the new subscription.',
  ...
  payment: {
    ...
    safari_payment_notice:
      'For Safari browser, please click the button below to proceed with payment',
  ...
  invite: {
    ...
    balance: {
      ...
      description:
        'Commissions earned from inviting friends can be transferred to spending balance',
  ...
  docs: {
    ...
    noAccessPrompt:
      'You currently have no active plan. Purchase a plan to view content in this section',
    ...
    languageHint:
      'No documentation available for current language {currentLang}, please try switching to another language',
    networkError: 'Network error',
    welcome: {
      title: 'Documentation Center',
  ...
  browserRestricted: {
    ...
    whyRestrictedDesc:
      'Some browsers may have security issues or lack necessary features. We restrict these browsers to ensure your account security and provide a better user experience.',
  ...
  wallet: {
    ...
    welcome: {
      ...
      description:
        'Here you can easily deposit funds into your account, choose preset amounts or enter a custom amount. Deposited balance will be credited instantly and can be used to purchase our services.',
    },
  },
};
