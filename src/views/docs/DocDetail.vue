      ...
      <div v-else class="doc-content">
        ...
        <div class="doc-header">
          ...
          <div class="doc-meta">
            ...
            <span class="doc-date"
              >{{ $t('docs.lastUpdated') }}: {{ formatDate(docData.updated_at) }}</span
            >
          </div>
        </div>
    ...
    try {
      ...
      if (isComplexHtml(content) || isComplexHtml(renderedMd)) {
        ...
        buttons.forEach((button) => {
          ...
          if (
            (buttonText.includes('复制') || buttonText.includes('copy')) &&
        ...
        links.forEach((link) => {
          if (
            link.textContent.trim().toLowerCase().includes('复制') ||
