...
const injectSiteName = (messages) => {
  Object.keys(messages).forEach((locale) => {
    if (messages[locale]?.common) {
      ...
      if (
        messages[locale].common.welcome &&
        messages[locale].common.welcome.includes('V2Board Admin')
      ) {
        messages[locale].common.welcome = messages[locale].common.welcome.replace(
          'V2Board Admin',
